...
const Dashboard: React.FC = () => {
    ...
    switch (user?.role) {
      ...
      case 1:
        return [
          ...
          {
            title: "Processed",
            value: pendingRequests.length + 8,
            icon: CheckCircle,
            color: "from-green-500 to-green-600",
            bgColor: "bg-green-50",
          },
          {
            title: "Team Requests",
            value: pendingRequests.length + 5,
            icon: Users,
  ...
  return (
    <div className="space-y-8">
      {/* Welcome Header */}
      <div
        className={`bg-gradient-to-r ${welcome.color} rounded-2xl p-8 text-white shadow-xl`}
      >
          ...
          {recentRequests.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="mt-2 text-gray-500">
                You haven't submitted any leave requests. Start by creating your
                first request.
              </p>
            </div>
          ) : (
